...
<p align="center">
  <img src="docs/screenshots/dashboard-sessions.png" width="700">
</p>
...
- **会话** — 所有活跃 Claude Code 会话的实时状态、Context 进度、模型、Token 用量
  ...
  <img src="docs/screenshots/dashboard-sessions.png" width="600">

- **今日** — 当日消耗独立视图，含近 90 日 P90 参考对比

  <img src="docs/screenshots/dashboard-today.png" width="600">

- **用量** — Token 趋势图、模型分布、项目排行、成本统计，支持按日/7天/30天/90天筛选

  <img src="docs/screenshots/dashboard-usage.png" width="600">
